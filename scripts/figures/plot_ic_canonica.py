...
print("  duration         %9.2f s   (paper 1 publishes 7.67)" % hist["t"][-1])
print("  gamma min        %+9.2f deg (paper 1 publishes -3.3)" % min(g))
print("  alpha max        %+9.2f deg" % max(a))
print("  mean elevator    %+9.2f deg (paper 1: equivalent control -5)" % de.mean())
print("  mean throttle    %9.3f      fraction at full %.3f" % (d.mean(), np.mean(d>0.99)))
